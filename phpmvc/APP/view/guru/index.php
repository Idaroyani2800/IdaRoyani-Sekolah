                    ...
                    <?php foreach ($data['guru'] as $guru) : ?>
                      <tr>
                        ...
                        <td><?= $guru['nama']; ?></td>
                         ...
                         class="badge badge-success  tampilModalUbah" data-toggle="modal" data-target="#staticBackdrop" data-id="<?= $guru['id']; ?>">ubah</a>
      ...
      <form action="<?= BASE_URL; ?>/guru/tambah" method="post"> 
        ...
        <div class="form-group"> 
          ...
          <select class="form-control" id="guru_mapel" name="guru_mapel"> 
            <option value="laki-laki">Pemrogaman Web dan Per</option> 
